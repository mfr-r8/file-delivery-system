...
<body>
    ...
    <div class="section">
        ...
        <ol>
            ...
            <li>استمارة 6 أو 7 جند (عدد 4 صور)</li>
            <li>استمارة 2 جند</li>
        </ol>
    </div>
    ...
    <div class="section">
        ...
        <ol>
            ...
            <li>نسخة من استمارة رفع صور من الأصول على موقع MIS (استمارة التسجيل الإلكتروني)</li>
            ...
            <li>استمارة التربية العسكرية (من شؤون الطلاب) مع ملء البيانات بها</li>
        </ol>
